          ...
          <CardContent className="p-6 space-y-6">
            <div className="space-y-4 text-sm">
              <p className="text-muted-foreground leading-relaxed">
                O acesso foi provisionado. Por segurança, a senha temporária abaixo será exibida
                apenas uma vez.
              </p>
            ...
            <Alert
              variant="destructive"
              className="bg-amber-50 dark:bg-amber-950/20 text-amber-900 dark:text-amber-100 border-amber-200 dark:border-amber-900"
            >
    ...
    <main className="container mx-auto max-w-2xl px-4 py-8">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">
          Preencha os dados básicos para criar o acesso operacional.
        </p>
      </div>
              ...
              <div className="flex items-center gap-2">
                <Input
                  ...
                  onChange={(e) =>
                    setFormData((prev) => ({
                      ...prev,
                      loginIdentifier: e.target.value.toLowerCase().replace(/[^a-z0-9._]/g, ""),
                    }))
                  }
                  required
                />
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Pode receber novas atribuições imediatamente.
                  </p>
                </div>
                <Switch
                  checked={formData.canAcceptDeliveries}
                  onCheckedChange={(val) =>
                    setFormData((prev) => ({ ...prev, canAcceptDeliveries: val }))
                  }
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Desative para bloquear o acesso sem excluir os dados.
                  </p>
                </div>
                <Switch
