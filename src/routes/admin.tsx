...
const NAV = [
  ...
  { href: "/admin/suporte", label: "Suporte às lojas", icon: Headphones },
  { href: "/admin/excecoes-financeiras", label: "Exceções financeiras", icon: CircleDollarSign },
  { href: "/admin/previews", label: "Previews visuais", icon: Eye },
  { href: "/admin/modelos-solicitados", label: "Novos modelos", icon: Layers3 },
