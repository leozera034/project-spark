...
function CaptureRedirect() {
  ...
  useEffect(() => {
    void (async () => {
      ...
      if (signInError) {
        setError("Falha ao autenticar conta QA de captura.");
        return;
      }
  ...
  return (
    <main style={{ minHeight: "100vh", display: "grid", placeItems: "center", background: "#FCFAF8", fontFamily: "sans-serif" }}>
      <p>{error || "Preparando captura do COMANDIVA…"}</p>
    </main>
  );
}
