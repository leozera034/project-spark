...
>(({ side = "right", className, children, style, ...props }, ref) => {
  const isStorefrontProductSheet =
    side === "bottom" && className?.includes("h-[min(92dvh,52rem)]");
  const contentStyle: React.CSSProperties | undefined = isStorefrontProductSheet
    ? {
        ...style,
        left: "50%",
        right: "auto",
