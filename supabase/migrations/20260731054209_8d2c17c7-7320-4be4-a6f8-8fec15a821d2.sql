...
BEGIN
  ...
  -- Criado com valores zerados: a consistência de totais só é fechada depois
  -- que todas as linhas forem recalculadas pelo motor canônico.
  INSERT INTO public.orders (
    ...
    v_change, 0, 0, 0, 0, v_min, v_eta, v_notes, v_key, v_hash, 'publico'
